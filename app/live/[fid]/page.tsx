      ...
      <main className="app-container py-6">
        <div className="lg:grid lg:grid-cols-3 lg:gap-6 max-w-md lg:max-w-none mx-auto">
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            <PitchMomentum tier={tier} attacker={attacker} iso1={entry?.iso1} iso2={entry?.iso2} label={ti.label} color={ti.color} hot={hot} score={score} corner={cornerSig} paused={!running} />
