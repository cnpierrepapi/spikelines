...
export async function GET(request: Request) {
  ...
  const cols = "id,device_id,username,fixture_id,match,mode,market,side,stat_key,mins,choice,outcome,reward,base_ts,settle_ts,proof_status,proof_root,created_at";
